...
- [x] Dry-run emits `hops_exceed_max_launches`; `run-backlog-wave.sh` preflight-fails it. Do not create a wave whose hops cannot finish under the cap.
